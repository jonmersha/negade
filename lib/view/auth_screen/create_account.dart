...
//
// class AcreateAccount extends StatefulWidget {
//   const AcreateAccount({super.key});
//
//   @override
//   State<AcreateAccount> createState() => _AcreateAccountState();
// }
//
// class _AcreateAccountState extends State<AcreateAccount> {
//   bool inlogin = false;
...
//                                 color: greyShade1),
//                             child: textDisplaySmall(textTheme:textTheme,currentCountry: currentCountry),
//                           ),
//                         ),
//                         //For Mobile numbers
//                         textForm(
...
//
//                         if(!inlogin)
//                           buildElevatedButton(width, height, textTheme,"Verify Mobile number"),
//                         if(inlogin)
//                         buildElevatedButton(width, height, textTheme,"Continue"),
//
...
//                   ]),
//                 ),
//                 blankSpace(height: height * 0.03, width: 0),
//                 if(!inlogin)
//                 custom_radio(
//                     message1: "Sign in",
//                     message2: "Already Customer",
